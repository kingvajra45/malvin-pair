    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hey there, KING-VAJRA User!* 👋🏻

Thanks for using my bot *KING-VAJRA* — your session has been successfully created!
...
{quoted:ddd })
   ...
   return await KING_VAJRA_PAIR_CODE();
});/*
setInterval(() => {
